          ...
          <div className="container">
            <div className="hero-content">
              <h1 className="h1 hero-title">
                Une marque pour toute la famille
              </h1>

              <p className="hero-text">
                Notre mission est de vous offrir une expérience gustative
                inoubliable, tout en favorisant une vie saine et durable pour
              ...
              <ul>
                <li className="about-item">
                  ...
                  >
                    ...
                    <p className="accordion-content">
                      Nous nous engageons à n'utiliser que les ingrédients les
                      plus frais et les plus nutritifs dans nos produits. Nos
                      produits laitiers et nos jus sont fabriqués avec soin et
                      attention pour garantir que chaque gorgée soit pleine de
                      saveur et de nutriments.
                    </p>
                  </div>
                </li>
                ...
                <li className="about-item">
                  ...
                  >
                    ...
                    <p className="accordion-content">
                      Nous croyons qu'il est important de protéger
                      l'environnement et de promouvoir un mode de vie durable.
                      C'est pourquoi nous utilisons des pratiques éthiques et
                      durables tout au long de notre chaîne d'approvisionnement,
                      de la sélection des ingrédients à l'emballage et
                      l'expédition de nos produits.
                    </p>
                  </div>
                </li>
                ...
                <li className="about-item">
                  ...
                  >
                    ...
                    <p className="accordion-content">
                      Nous sommes dévoués à promouvoir un mode de vie sain et
                      équilibré pour nos clients. Nos produits sont conçus pour
                      offrir des options délicieuses et nutritives pour toute la
                      famille, tout en favorisant un mode de vie actif et
                      durable.
                    </p>
                  </div>
                </li>
        ...
        <section className="section feature" aria-labelledby="feature-label">
          <div className="container">
            ...
            <div className="feature-content">
              ...
              <h2 className="h2 section-title">
                Optez pour une option saine et écologique, avec des jus et
                produits laitiers délicieux et naturels.
              </h2>

              <p className="section-text">
                Nos produits biologiques sont cultivés sans l'utilisation de
                pesticides et d'engrais chimiques nocifs, ce qui signifie que
                vous pouvez profiter de boissons et de produits laitiers sains
                et naturels sans compromettre votre santé ni celle de
                l'environnement.
              </p>
              ...
              <ul className="feature-list">
                <li>
                  <div className="feature-card">
                    ...
                    <span className="span">Respect de l'environnement</span>
                  </div>
                </li>
                ...
                <li>
                  <div className="feature-card">
                    ...
                    <span className="span">Produits plus sains</span>
                  </div>
                </li>
                ...
                <li>
                  <div className="feature-card">
                    ...
                    <span className="span">Pas d'engrais chimiques nocifs</span>
                  </div>
                </li>
                ...
                <li>
                  <div className="feature-card">
                    ...
                    <span className="span">Pas de pesticides nocifs</span>
                  </div>
                </li>
              </ul>
            </div>
