            ...
            <ul className="collection-list has-scrollbar">
              <li>
                <div className="collection-card">
                  ...
                  <a
                    href="https://www.instagram.com/p/CuXbEvgt5OR/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA=="
                    target="_blank"
              ...
              <li>
                ...
                >
                  ...
                  <a
                    href="https://www.instagram.com/p/CvK0c0_LlD0/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA=="
                    target="_blank"
                    className="btn btn-secondary"
                  >
                    <span>Explore All</span>
              ...
              <li>
                ...
                >
                  ...
                  <a
                    href="https://www.instagram.com/p/CvAiMacLGOy/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA=="
                    target="_blank"
                    className="btn btn-secondary"
                  >
                    <span>Explore All</span>
              ...
              <li>
                ...
                >
                  ...
                  <a
                    href="https://www.instagram.com/p/CvFxQ4xrHvm/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA=="
                    target="_blank"
                    className="btn btn-secondary"
                  >
                    <span>Explore All</span>
            ...
            {/* <ul className="filter-list">
              <li>
                <button
                  ...
                  className={`filter-btn ${btnHover == "all" ? "active" : ""}`}
                >
                  All
                </button>
              </li>
              ...
              <li>
                <button
                  onClick={handleProduct}
                  className={`filter-btn ${btnHover == "Jus" ? "active" : ""}`}
                >
                  Jus
                </button>
              </li>
              ...
              <li>
                <button
                  onClick={handleProduct}
                  className={`filter-btn ${btnHover == "Lait" ? "active" : ""}`}
                >
                  Lait
                </button>
              </li>
